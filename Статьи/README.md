...
## Почта без хлопот: автоматизация отправки писем с помощью Python
 ...
 - 
## Как я сравнила доходность алгоритмического и обычного портфеля и к каким выводам пришла
 - https://journal.tinkoff.ru/kak-ia-sravnila-dokhodnost-portfelia/
## Как проторговать нейросеть. Много пользы. Только тут
 - https://smart-lab.ru/blog/1064919.php
